    ...
    Rere.Window({ "Rere Feature Demo" })
        Rere.TabBar()
            ...
            Rere.Tab({ "About" })
                ...
                Rere.CollapsingHeader({ "Runtime info" })
                    Rere.Text({ "Place ID: " .. tostring(game.PlaceId) })
                    Rere.Text({ "Player: " .. game.Players.LocalPlayer.Name })
                    Rere.Text({ "Status: " .. status:get() })
                Rere.End()

                Rere.CollapsingHeader({ "Animation" })
                    Rere.Text({ "Dropdown and arrow duration: 0.15 seconds" })
                    Rere.Text({ "The triangle rotates from right to down." })
                Rere.End()
            Rere.End()
        Rere.End()
    Rere.End()
